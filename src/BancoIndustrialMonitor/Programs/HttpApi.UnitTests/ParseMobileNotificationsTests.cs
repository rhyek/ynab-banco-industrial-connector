...
using BIMonitor.Models;
using Xunit;

namespace HttpApi.UnitTests;

public class ParseMobileNotificationsTests
{
  [Theory]
    ...
    MobileNotificationTransaction? expected)
  {
    ...
    var actual = MobileNotificationTransaction.FromMessage(message, currentDateTime);
  ...
  public static IEnumerable<object?[]> ParseMobileNotificationsData =>
    new List<object?[]> {
      new object?[] {
        ...
        new MobileNotificationTransaction(Reference: "122454", Currency: "US",
      ...
      new object?[] {
        ...
        new MobileNotificationTransaction(Reference: "201910", Currency: "Q",
      ...
      new object?[] {
        ...
        new MobileNotificationTransaction(Reference: "894839", Currency: "US",
      ...
      new object?[] {
        ...
        new MobileNotificationTransaction(Reference: "1782905", Currency: "US",
          Amount: 2000.0m, Type: TransactionType.Credit, Description: "CENTRAL",
      ...
      new object?[] {
        ...
        new MobileNotificationTransaction(Reference: "238022", Currency: "Q",
          Amount: 163.34m, Type: TransactionType.Debit, Description: "SUPERMERCADOS LA TORRE",
