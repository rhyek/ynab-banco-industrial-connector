...
public class MobileNotificationTransactionTests
{
    public static IEnumerable<object?[]> ParseMobileNotificationsData =>
        new List<object?[]>
        {
            ...
            new object?[]
            {
                "BiMovil: Consumo por Q.579.15 en: EST. DE SERV. (BELLA AU Cuenta: BICHEQUE6 29-Jul 13:41 Aut.200966.",
                new MobileNotificationTransaction
                {
                    Reference = "200966",
                    Currency = "GTQ",
                    Amount = 579.15m,
                    Type = TransactionType.Debit,
                    Description = "EST. DE SERV. (BELLA AU",
                    Account = "BICHEQUE6",
                    DateTime = new(2022, 7, 29, 13, 41, 0),
                    Origin = TransactionOrigin.Establishment
                }
            },
            new object?[]
