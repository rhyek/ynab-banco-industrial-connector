export const backendEnvironmentVariableKeys = [
  'YNAB__PersonalAccessToken',
  'YNAB__BudgetId',
  'YNAB__DebitCardAccountId',
  'YNAB__CreditCardAccountId',
  'BANCO_INDUSTRIAL_SCRAPER__Auth__UserId',
  'BANCO_INDUSTRIAL_SCRAPER__Auth__Username',
